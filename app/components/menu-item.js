...
menuItemComponent.prototype.resize = function(delay, y, menuGroupWidth) {
  ...
  this.menuItemIcon.x.anim().from(this.menuItemIcon.x()).to(50).dur(250).delay(delay).start();
  ...
  this.menuItemIconSelected.x.anim().from(this.menuItemIcon.x()).to(50).dur(250).delay(delay).start();
  ...
  this.menuItemIconActive.x.anim().from(this.menuItemIcon.x()).to(50).dur(250).delay(delay).start();
